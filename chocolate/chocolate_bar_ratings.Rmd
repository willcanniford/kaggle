...
Firstly, let's read in the packages that I am going to be using.
```{r eval=FALSE}
library(tidyverse)
library(ggplot2)
library(readr)
...
```{r}
# Removing the spaces and line breaks
...
We can now use that new date column to create some summary statistics for each year. 
```{r}
...
Thanks for taking the time to have a look at my visualisations.
